...
This is the repository of the API and Wordpress front end for IDC WIN BIG.  Several key plugins are needed to make the system work:

  - jwt-authentication-for-wp-rest-api
  - replace-wp-login
  - idc-auth
  
Many other plugins exist on the production system - but these are managed by Wordpress and not relevant to the custom elements of the system.
